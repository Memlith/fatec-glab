...
export async function fetchLaboratories(
  setLabs: React.Dispatch<React.SetStateAction<Laboratory[]>>
) {
  try {
...
export async function fetchLaboratoryById(id: number) {
  try {
...
export async function createLaboratory(lab: Laboratory) {
  try {
...
export async function updateLaboratory(id: number, lab: Laboratory) {
  try {
